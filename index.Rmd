...
```{r echo=FALSE,fig.height=10,results='asis',warning=FALSE}
library(ggplot2)
setwd("~/Documents/coursera/r/9.DevelopingDataProducts/Course Project/ShinyApps/CampaignSignificance")
rawData <- readRDS("data/exampleData.rds")      # Load example data to use if no data uploaded yet
